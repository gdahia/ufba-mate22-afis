...
legend("bottomright", inset=.05, cex = 0.75, c("Impressão digital - detecção manual", "Impressão digital - detecção automática", "Iris - detecção manual", "Iris + Impressão digital - manual"), lty=c(1,1,1,1), lwd=c(2,2,2,2), col=c("blue", "red", "darkgreen", "green"), bg="grey96")
